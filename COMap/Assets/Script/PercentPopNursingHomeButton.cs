...
public class PercentPopNursingHomeButton : MonoBehaviour {

	public GameObject ButtonPPNH;
...
//				NHCounties[current].SetActive(true);
	...
	//}
		...
		if (ButtonPPNH.activeInHierarchy == true)
			ButtonPPNH.SetActive(false);
		else
			ButtonPPNH.SetActive(true);
	}	
